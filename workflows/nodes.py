...
9. '4. 기술별 경쟁사 비교표'의 '주요 차별점 및 특징'과 'SK하이닉스 대응 포인트'는 셀당 1문장 또는 짧은 구문으로 제한할 것
10. '주요 차별점 및 특징'에는 회사별 핵심 포인트만 매우 짧게 넣고 줄바꿈을 남발하지 말 것
11. 경쟁사 동향 분석 표는 기술 열이 가장 왼쪽에 오도록 작성할 것
12. 보고서 최상단에는 제목과 작성일을 아래 형식으로 먼저 둘 것
# SK하이닉스 관점 반도체 기술 전략 분석 보고서
작성일: YYYY-MM-DD"""
    user_prompt = f"""초안:
{state['draft_report']}
